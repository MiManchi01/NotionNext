...
const BLOG = {
  ...
  AUTHOR: '北天', // 作者
  BIO: '知足 上进 不负野心✨', // 作者简介
  LINK: 'https://blog.csdn.net/qq_52417436?spm=1000.2115.3001.5343', // 网站地址
  KEYWORDS: 'Notion, 博客, Python, 技术分享', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: 'bei_tian.lucky@foxmail.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/MiManchi01?tab=repositories', // 你的github个人主页
  ...
  MUSIC_PLAYER_METING_ID: process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '7838708759', // 对应歌单的 id
  ...
  COMMENT_VALINE_PLACEHOLDER: process.env.NEXT_PUBLIC_VALINE_PLACEHOLDER || '欢迎前来评论~', // 可以搭配后台管理评论 https://github.com/DesertsP/Valine-Admin  便于查看评论，以及邮件通知，垃圾评论过滤等功能
